...
public class RetrieveExams extends AsyncTask<String,Void,String> {
    ...
    protected void onPreExecute(){
        json_url = "http://35.160.125.84/rest/getPatientsExams.php";
        ...
        if(result==null){
            ...
            try {
                ...
                while(count<jsonArray.length()){
                    ...
                    exam.setUsername(jo.getString("pusername"));
                    exam.setId(Integer.parseInt(jo.getString("id")));
                    exam.setMsusername(jo.getString("msusername"));
                    exam.setType(jo.getString("type"));
                    exam.setResults(jo.getString("results"));
                    exam.setTimestamp(Timestamp.valueOf(jo.getString("date")));
                    exam.setAdvice(jo.getString("advice"));
                    dbH.addExam(exam);
                    count++;
                }
