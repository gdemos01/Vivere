 ...
 */
public class VivereNotificationService extends IntentService {
    private static final String TAG = VivereNotificationService.class.getSimpleName();
    public static final int NOTIFICATION_ID = 123;

    private Handler mHandler;

    public VivereNotificationService() {
